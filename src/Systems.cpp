...
bool PlayerSystem::init(ECSContext& context) {
...
bool ZombieSystem::init(ECSContext& context) {
...
bool LevelSystem::init(ECSContext& context) {
...
bool EffectsSystem::init(ECSContext& context) {
...
bool PenetrationResolutionSystem::init(ECSContext& context) {
...
bool BulletSystem::init(ECSContext& context) {
...
UIRenderingSystem::~UIRenderingSystem() {
  ...
  auto freeSprite = [](Sprite* sprite) {
    if(sprite != nullptr) {
      destroySprite(sprite);
    }
  };

  freeSprite(m_weaponSprite);
  freeSprite(m_radarSprite);
  freeSprite(m_arrowSprite);
  freeSprite(m_xiconSprite);
  freeSprite(m_circleSprite);
  freeSprite(m_reticleSprite);
}

bool UIRenderingSystem::init(ECSContext& context) {
  ...
  if(m_radarSprite == nullptr || m_weaponSprite == nullptr ||
     m_arrowSprite == nullptr || m_xiconSprite == nullptr ||
     m_circleSprite == nullptr || m_reticleSprite == nullptr) {
